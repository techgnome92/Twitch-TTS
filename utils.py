...
ignored_words = load_json("data/filters/word_ignore.json")
replace_words = load_json("data/filters/word_replace.json")
regex_filter = load_json("data/filters/regex_filters.json")
